...
def main(parser):
    ...
    parser.add_argument('--config', type=str, default='configs/gbs/density_sky_uniform.yaml',
    ...
    elif config['model']['base']['distribution'] == 2:
        distribution = UniformUnit((features_size,)).to(dev)
    else:
        acceptance_fn = MLP(
