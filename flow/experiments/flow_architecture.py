...
def create_base_transform(i,config):
    ...
    context_features = config['model']['context']['context_features']
...
def create_base_transform_affine(i, features, context_features):
        #'affine-coupling'
        features = features
        context_features = context_features
        hidden_features = 512
...
def create_transform(config):
    ...
    transform = CompositeTransform([
        CompositeTransform([
            ...
            create_base_transform_affine(i, features, context_features),
            create_base_transform(i, config) #    create_base_transform_affine(i, features, context_features)
