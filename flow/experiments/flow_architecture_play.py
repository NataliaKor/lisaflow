...
def create_batchnorm_transform(features):
    ...
    return BatchNorm(features, eps=1e-7, momentum=0.99)
...
def create_base_transform_affine(i, config, features, context_features):
        #'affine-coupling'
        features = features
        context_features = context_features
...
def create_transform(config):
    ...
    transform = CompositeTransform([
        CompositeTransform([
            ...
            create_base_transform_affine(i, config, features, context_features),
            #create_batchnorm_transform(features)
